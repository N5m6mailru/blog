   ...
   <div class="container my-5">
       <div class="col-sm-4 mx-auto">
           ...
           <form action="php/handlerReg.php" method="POST">
              ...
              <div class="mb-3">
                  <input name ="lastname" type="text" class="formt-control" placeholder="Введите фамилию">
              </div>
              <div class="mb-3">
                  <input name ="email" type="email" class="formt-control" placeholder="Введите email">
              </div>
              <div class="mb-3">
                  <input name ="password" type="password" class="formt-control" placeholder="Введите пароль">
              </div>
              <div class="mb-3">
